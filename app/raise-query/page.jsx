// app/patient/(protected)/raise-query/page.jsx
"use client";
...
import {
  ...
  Star, Zap, Clock, Paperclip, Image, File,
  Upload, Trash2
} from 'lucide-react';
...
export default function PatientRaiseQueryPage() {
  ...
  const fetchRecentQueries = async () => {
    try {
      ...
      const response = await fetch('/api/patient/queries?limit=5');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ FIX: Redirect to /queries instead of /patient/queries
      setTimeout(() => {
        router.push('/queries');
      }, 2000);
    } catch (error) {
