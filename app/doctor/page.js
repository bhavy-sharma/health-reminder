            ...
            <div>
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-xs">
                  <span className="bg-[var(--color-cream)] px-4 text-[var(--color-text-muted)]">or</span>
                </div>
              </div>

              <button 
                type="button"
                className="w-full bg-white text-[var(--color-text-secondary)] border border-[var(--color-border)] py-3.5 rounded-[var(--radius-input)] font-medium flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors shadow-sm"
              >
