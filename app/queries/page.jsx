// app/patient/(protected)/queries/page.jsx
"use client";
...
export default function PatientQueriesPage() {
  ...
  const fetchQueries = async () => {
    try {
      ...
      const response = await fetch(`/api/patient/queries?${params}`);
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      <main className="md:pl-[280px]">
        <div className="p-4 sm:p-6 md:p-8 pb-20 max-w-[1200px] mx-auto pt-16 md:pt-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0D1B2A] bg-white"
              />
            </div>
            <select
              value={statusFilter}
          ...
          <div className="space-y-4">
            {queries.length === 0 ? (
              ...
              queries.map((query) => (
                <div
                  key={query._id}
                  onClick={() => router.push(`/queries/${query._id}`)}
