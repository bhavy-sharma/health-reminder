export default function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      badge: "Life-Saving",
      description:
        "Store allergies and critical medical info. Emergency QR code for paramedics. Blood group displayed prominently.",
      checkmark: "Save to phone home screen for offline access",
      preview: (
        <div className="bg-[#F5F3EF] rounded-xl p-8 flex flex-col items-center justify-center min-h-[200px]">
          <div className="text-center">
            <p className="text-5xl font-bold text-red-500 mb-2">B+</p>
            <p className="text-sm text-red-400 bg-red-50 px-3 py-1 rounded-full inline-block">
